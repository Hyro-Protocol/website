...
export function getUseFundsDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(USE_FUNDS_DISCRIMINATOR);
}

export type UseFundsInstruction<
...
export type UseFundsInstructionData = {
  discriminator: ReadonlyUint8Array;
  assets: bigint;
};

export type UseFundsInstructionDataArgs = { assets: number | bigint };
...
export function getUseFundsInstructionDataCodec(): FixedSizeCodec<
  UseFundsInstructionDataArgs,
  UseFundsInstructionData
> {
  return combineCodec(
...
export type UseFundsAsyncInput<
...
export type ParsedUseFundsInstruction<
  TProgram extends string = typeof HYRO_PROTOCOL_PROGRAM_ADDRESS,
...
> = {
  ...
  data: UseFundsInstructionData;
};

export function parseUseFundsInstruction<
...
>(
  ...
  return {
    ...
    data: getUseFundsInstructionDataDecoder().decode(instruction.data),
  };
}
